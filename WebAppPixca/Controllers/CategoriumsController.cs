...
namespace WebAppPixca.Controllers
{
    public class CategoriumsController : Controller
    {
        ...
        public CategoriumsController(PixcaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Categoria != null ? 
                          ...
                          Problem("Entity set 'PixcaContext.Categoria'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'PixcaContext.Categoria'  is null.");
            }
            var categorium = await _context.Categoria.FindAsync(id);
            if (categorium != null)
            {
